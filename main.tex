...
%
% Що редагувати НЕ тут: усі особисті дані -- у config.tex; додаткові
% пакети й власні команди -- у preamble.tex (не в kpithesis.cls!).
...
\input{chapters/02-chapter-01.tex}
\input{chapters/03-chapter-02.tex}
\input{chapters/04-chapter-03.tex}
